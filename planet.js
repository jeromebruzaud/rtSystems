...
// //body
// var bod = getRockyBody(d10());
// //gravity
// var grav = getRockyGravity(d10(), getRockyGravitymod(this.body));
// //orbitalFeatures
// var orbFeat =getRockyOrbitalFeatures(getRockyOrbitalFeaturesMod(gravity));
// //atmo
// var at = getRockyAtmo(d10(), getRockyAtmoMod(gravity));
// //atmocomp
// var atcomp = getRockyAtmoComp(d10(), atmo);
// //climate
// var clim = getRockyClimate(d10());
// //hab
// var ha = getRockyHab(d10(), getRockyHabMod(climate), atmo, atmocomp);


//Constructor (Tables 6-12, P. 19-23)
class Rockyplanet {
    constructor(){
        this.body = getRockyBody(d10()), 
        this.gravity = getRockyGravity(d10(), getRockyGravitymod(this.body)),
        this.orbitalFeatures = getRockyOrbitalFeatures(getRockyOrbitalFeaturesMod(gravity)),
        this.atmo = getRockyAtmo(d10(), getRockyAtmoMod(this.gravity)),
        this.atmocomp = getRockyAtmoComp(d10(), this.atmo),
        this.climate = getRockyClimate(d10()),
        this.hab = getRockyHab(d10(), getRockyHabMod(this.climate), this.atmo, this.atmocomp)
    }
        //Roll Functions
        d2(){
...
const Planet = new Rockyplanet();
    // Planet.body = getRockyBody(d10()), 
    // Planet.gravity = getRockyGravity(d10(), getRockyGravitymod(this.body)), 
    // Planet.orbitalFeatures = getRockyOrbitalFeatures(getRockyOrbitalFeaturesMod(this.gravity)), 
    // Planet.Atmo = getRockyAtmo(d10(), getRockyAtmoMod(this.gravity)), 
    // Planet.atmocomp = getRockyAtmoComp(d10(), this.atmo), 
    // Planet.climate = getRockyClimate(d10()), 
    // Planet.hab = getRockyHab(d10(), getRockyHabMod(this.climate), this.atmo, this.atmocomp);
console.log(Planet);
